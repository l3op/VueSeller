<template>
  <div class="common_enquirie">
      ...
      <div class="bottom_opt">
        <span class="time">
          <i class="icon-font">&#xe67f;</i>
          {{commonEnquirie.enquiryTime | time-formater-no-hour}}
          <span class="source" v-if="commonEnquirie.keywordMatchs !== null && commonEnquirie.keywordMatchs.length !== 0">
              <em></em>
              来源:
              <span class="keywords">
                <span v-if="commonEnquirie.keywordMatchs[0].type === 'explore' && commonEnquirie.keywordMatchs[0].isMatched === 1">探索关键字</span>
                <span v-if="commonEnquirie.keywordMatchs[0].type === 'system' && commonEnquirie.keywordMatchs[0].isMatched === 1">系统关键字</span>
                <span v-if="commonEnquirie.keywordMatchs[0].type === 'detective' && commonEnquirie.keywordMatchs[0].isMatched === 1">外贸侦探关键字</span>
                <span v-if="commonEnquirie.keywordMatchs[0].type === 'product' && commonEnquirie.keywordMatchs[0].isMatched === 1">商品分类关键字</span>
                <span v-if="commonEnquirie.keywordMatchs[0].type === 'seo' && commonEnquirie.keywordMatchs[0].isMatched === 1">SEO关键字</span>
              </span>
          </span>
        </span>
